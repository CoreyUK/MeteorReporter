...
Everything shared through the plugin is also on the web at **[meteor.shep.rip](https://meteor.shep.rip)** — active stars on a map of Gielinor, upcoming stars from telescope readings, and a leaderboard of the people who share the most. The plugin links to it from the bottom of its panel.
